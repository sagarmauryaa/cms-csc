...
export interface ApiAcademicsAdmissionAcademicsAdmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'academics_admissions';
  info: {
    displayName: 'Academics Admission';
    pluralName: 'academics-admissions';
    singularName: 'academics-admission';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::academics-admission.academics-admission'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiFacultyFaculty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    FacultyType: Schema.Attribute.Enumeration<
      ['Degree College', 'Junior College', 'Non-Teaching']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiRecognitionRecognition extends Struct.CollectionTypeSchema {
...
export interface ApiResearchPaperResearchPaper
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    PublishedBy: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiResultResult extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ExaminationType: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::result.result'
    ...
    PDFFile: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Semester: Schema.Attribute.Enumeration<['I', 'II', 'III', 'IV', 'V', 'VI']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
